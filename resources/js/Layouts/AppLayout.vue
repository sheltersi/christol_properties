<template>
    <div>
      <nav class=" bg-white border-b shadow-xs sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            ...
            <div class="hidden md:flex items-center space-x-6">
              ...
              <Link href="/apply-to-rent/create" class="nav-link">Apply to Rent</Link>
            ...
            <div class="md:hidden flex items-center">
              <button @click="isOpen = !isOpen" class="text-gray-800 focus:outline-hidden">
